...
export const mockLots: LotWithFarmer[] = [
  {
    farmer: {
      ...
      invited: true,
      biography: "کشاورز فعال در آمل با تمرکز بر کیفیت برداشت.",
      status: "active",
    },
    lot: {
      id: "1",
  ...
  },
  {
    farmer: {
      ...
      invited: true,
      biography: "تأمین‌کننده محصولات محدود با تحویل به‌موقع.",
      status: "active",
    },
    lot: {
      id: "2",
  ...
  },
  {
    farmer: {
      ...
      invited: true,
      biography: "کشاورز باسابقه با تمرکز بر شفافیت زنجیره.",
      status: "active",
    },
    lot: {
      id: "3",
